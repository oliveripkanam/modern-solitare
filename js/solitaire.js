...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Check if win message element exists
    console.log("Win message element:", winMessage);
    
    // Explicitly hide the win message
    console.log("Win message visibility before:", winMessage.classList.contains('hidden') ? "hidden" : "visible");
    winMessage.classList.add('hidden');
    console.log("Win message visibility after:", winMessage.classList.contains('hidden') ? "hidden" : "visible");
...
function resetGame() {
    ...
    console.log("Win message visibility at start of reset:", winMessage.classList.contains('hidden') ? "hidden" : "visible");
    ...
    console.log("Win message visibility after reset:", winMessage.classList.contains('hidden') ? "hidden" : "visible");
}
...
function renderGame() {
    ...
    checkWinCondition();
    console.log("Win condition check complete");
}
...
function checkWinCondition() {
    console.log("checkWinCondition called. moveCount:", moveCount);
    console.log("Foundation piles:", foundationPiles.map(pile => pile.length));
    console.log("Win message visibility at start of check:", winMessage.classList.contains('hidden') ? "hidden" : "visible");
    
    // First check if any cards have been moved (moveCount > 0)
    // This prevents win detection on initial load
    if (moveCount === 0) {
        console.log("Preventing win because moveCount is 0");
        // Force hide the win message if moveCount is 0
        winMessage.classList.add('hidden');
        console.log("Win message visibility after forcing hidden:", winMessage.classList.contains('hidden') ? "hidden" : "visible");
        return false;
    }
